...
} from "../../../service/contracts/organizations.service.ports.js";
...
export const deactivateOrganizationMemberServiceTestCommand = {
  actorRole: "admin" as const,
  organizationId: organizationServiceTestOrganization.id,
  userId: organizationServiceTestMember.userId,
};
...
export function createOrganizationMemberRoleLookup(
  ...
  return {
    ...
    >(() => Promise.resolve({ membershipStatus: "active", role: "admin" })),
    ...overrides,
  };
}
...
export function createOrganizationMemberStatusUpdater(
  overrides: Partial<OrganizationMemberStatusUpdaterPort> = {},
): OrganizationMemberStatusUpdaterPort {
  return {
    updateStatusByOrganizationIdAndUserId: vi.fn<
      OrganizationMemberStatusUpdaterPort["updateStatusByOrganizationIdAndUserId"]
    >((input) =>
      Promise.resolve({
...
export function createOrganizationsService(
  ...
  return new OrganizationsService(
    ...
    input.organizationMemberStatusUpdater ?? createOrganizationMemberStatusUpdater(),
  );
}
